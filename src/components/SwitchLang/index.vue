<template>
  <DropDown :show="switchLanguage" @blur="switchLanguage = false">
    <button
    ...
    <template #menu>
      <ul
        class="z-[1000] float-left mt-2 ml-2 min-w-max list-none overflow-hidden rounded-lg border-none bg-white bg-clip-padding text-left text-base shadow-lg dark:bg-gray-600 [&[data-te-dropdown-show]]:block"
